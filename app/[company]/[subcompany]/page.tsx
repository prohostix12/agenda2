    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href={`/${org}/${company}/admin`} className="border border-orange-200 bg-orange-50 text-orange-700 px-3 py-2 rounded-xl font-semibold text-sm hover:bg-orange-100 transition-colors flex items-center gap-2 relative">
