      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 space-y-6">
        <div>
          ...
          <input
            ...
            placeholder="e.g. Board Meeting Q2 2026"
        ...
        <div>
          ...
          <input
            name="chairperson" value={form.chairperson} onChange={handleChange}
        ...
        <div>
          ...
          <p className="text-xs text-gray-400 mt-1">
            Click &ldquo;New Meet&rdquo; to create a link on Google Meet, then paste it above.
          </p>
        </div>
